...
# keys=[l[1]for l in languages]
# values=[l[3]for l in languages]
# lookup=[(l[3], l[1]) for l in languages]
# TODO: via comprehensions, even though there's minimal benefit
language_dict= {}
for i in range(len(languages)):
    language_dict[languages[i][1]] = languages[i][3]
